  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-4">
        <h1 className="font-headline text-6xl md:text-8xl font-bold text-primary-foreground animate-in fade-in slide-in-from-bottom-4 duration-1000">
          Dream Weaver
        </h1>
        <p className="mt-4 max-w-2xl font-body text-lg md:text-xl text-foreground/80 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-300">
